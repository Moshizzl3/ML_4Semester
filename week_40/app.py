...
myModel = load_model('model_catordog.h5')

singlePred = 'week_40/cat-dog/single_prediction/cat_or_dog_2.jpg'
...
if result[0][0] < 0.5:
    print("cat")  # depending on the value of training_set.class_indices
else:
    print("dog")
