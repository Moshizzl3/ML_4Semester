...
dataFrame = pd.read_csv(
    'week_38/customer_staying_or_not/customer_staying_or_not.csv')
...
# This replaces 0 with -1, but adds collumn,  column should be excluded in the ilocs statement
# X['IsActiveMember'] = dataFrame['IsActiveMember'].apply(
